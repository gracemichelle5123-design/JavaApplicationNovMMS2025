...
public class KnightsTourClosedTest {
    ...
    public static void main(String[] args) {
        ...
        if (moveCount == 64) {
            int rowDiff = Math.abs(currentRow - startRow);
            int colDiff = Math.abs(currentColumn - startColumn);
            boolean closed = (rowDiff == 1 && colDiff == 2) || (rowDiff == 2 && colDiff == 1);
            System.out.println(closed ? "This was a CLOSED tour!" : "Full tour, but not closed.");
        }
    }
